      ...
      <div>
        ...
        <div className="w-full bg-[#111111] text-white py-2.5 px-6 flex justify-between items-center text-xs border-b border-gray-800 shadow-sm">
          <div className="flex items-center space-x-3">
            <button className="bg-[#008000] text-white text-[11px] font-bold uppercase tracking-wider px-3.5 py-1 rounded shadow-2xs cursor-default">
              Reader
            </button>
            <span className="font-semibold text-gray-200">
              Reader Dashboard {user ? `(${user.full_name} - ${user.email})` : ""}
            </span>
          </div>
          <button
