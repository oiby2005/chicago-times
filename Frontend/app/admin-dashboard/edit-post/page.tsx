...
export default function AdminEditPostPage() {
  ...
  // Target article ID being edited
  ...
  // =========================================================================
  // ADMIN ACTION BUTTON HANDLERS (Returns to Published Posts tab)
  // =========================================================================
  const handleApproveAndPublish = () => {
    ...
    // Manage Homepage Placement Queues for All Categories
    const SECTION_LIMITS = [
      ...
      { keyword: "Your Weekend", max: 3 },
      { keyword: "People to know", max: 3 },
      { keyword: "Most Popular News", max: 5 },
      { keyword: "A+ Section 2", max: 1 },
      { keyword: "Business", max: 8 },
      { keyword: "World Politics", max: 4 },
      { keyword: "Editorials", max: 4 },
      { keyword: "Politics", max: 4 },
      { keyword: "Tech", max: 4 },
      { keyword: "Sport", max: 4 },
      { keyword: "Entertainment", max: 4 },
      { keyword: "Fashion", max: 4 },
      { keyword: "Science", max: 4 },
      { keyword: "Arts", max: 4 },
      { keyword: "Lifestyle", max: 4 },
      { keyword: "CEOs & Executives", max: 4 },
      { keyword: "Markets & Finance", max: 4 },
      { keyword: "Economy", max: 4 },
      { keyword: "Health", max: 4 },
      { keyword: "Investing", max: 4 },
      { keyword: "Crypto", max: 4 },
      { keyword: "Real Estate", max: 4 },
      { keyword: "Industries", max: 4 },
      { keyword: "Law", max: 4 },
  ...
  return (
    <div suppressHydrationWarning className="min-h-screen bg-[#f8fafc] text-[#0f172a] font-sans flex flex-col w-full touch-pan-y">
      <div>
        {/* ================================================================= */}
        {/* TOP NAVBAR (Exact match to review-post page layout)                */}
        {/* ================================================================= */}
        <header suppressHydrationWarning className="bg-[#0b132b] border-b border-[#1e293b] h-auto min-h-[56px] sm:min-h-[2cm] px-3 sm:px-6 lg:px-10 py-2 flex items-center justify-between sticky top-0 z-40 shadow-md flex-wrap sm:flex-nowrap gap-2">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 min-w-0">
            <button
              onClick={() => router.push("/admin-dashboard?tab=Published Posts")}
            ...
            <span className="text-[#94a3b8] text-[10px] sm:text-xs font-mono font-extrabold uppercase tracking-widest truncate max-w-[150px] xs:max-w-[240px] sm:max-w-[400px]">
              {reviewPostId
                ? `Editing Published: ${headline.trim() || "Untitled Article"}`
                : `EDIT ${mainCategory.toUpperCase()} ARTICLE`}
            </span>
          </div>
        ...
        {/* ================================================================= */}
        {/* TWO COLUMN MAIN CONTENT CANVAS (100% Exact match to review-post)  */}
        {/* ================================================================= */}
