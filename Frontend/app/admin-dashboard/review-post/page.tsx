...
export default function AdminReviewPostPage() {
  ...
  const [articleAuthorEmail, setArticleAuthorEmail] = useState("");
    ...
    if (typeof window !== "undefined") {
      ...
      if (postId) {
        ...
        if (found) {
          ...
          if (found.authorEmail) setArticleAuthorEmail(found.authorEmail);
  ...
  const handleApproveAndPublish = () => {
    ...
    const updatedPost = {
      ...
      author: authorName,
      authorEmail: articleAuthorEmail || (existingPosts.find((p) => p.id === targetId)?.authorEmail || ""),
      thumbnail: thumb,
                      ...
                      <div className="space-y-5">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <div className="relative bg-[#f8fafc] border border-[#e2e8f0] rounded-2xl p-3.5 pr-2">
                            <div
                              id="review-subcat-scroll-container"
